...
2. **DNS Configuration with Terraform (IaC):**
   ...
   * Configure the `main.tf` file using the official [hetznercloud/hcloud](https://registry.terraform.io/providers/hetznercloud/hcloud/latest) provider to register the DNS zone for `ndromero.com`.
