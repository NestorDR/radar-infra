...
(
    ...
    CONSTRAINT ratios_symbol_strategy_inputs_timeframe_islong_unique
...
COMMENT ON COLUMN public.ratios.current_indicators IS 'Current indicator value or values associated with the evaluated strategy';
